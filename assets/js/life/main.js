...
(function()
{
    ...
    window.onload = function()
    {
        ...
        function init_ui()
        {
            ...
            {
                var color = document.getElementById("new_cell_color").value;

                // Changing background color.
                drawer.cell_color = color.toString(16);
            };

            $("submit_page_color").onclick = function()
            {
                var color = document.getElementById("new_page_color").value;

                // Changing canvas color
                document.getElementsByTagName("body")[0].style.backgroundColor = color.toString(16);
            };
