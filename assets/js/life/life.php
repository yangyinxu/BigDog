...
<div id="overlay">
    ...
    <div id="settings_dialog" style="display: none;">
        ...
        <br>
        <hr>
        <form id="page_color_submit">
            Page Color:
            <pre></pre>
            <input id="new_page_color" type="text" />
            <input id="submit_page_color" value="Submit" type="button" />
        </form>
        <br>
        <form id="background_color_submit">
            ...
            <input id="submit_bg_color" value="Submit" type="button" />
        </form>
        <br>
        <form id="cell_color_submit">
            ...
            <input id="submit_cell_color" value="Submit" type="button" />
        </form>
    </div>
